.PHONY: format lint test test-e2e-fastapi test-e2e-aiohttp test-e2e-celery docs examples-readme benchmark benchmark-diwire benchmark-comparison benchmark-json benchmark-report benchmark-report-all benchmark-json-resolve benchmark-report-resolve
